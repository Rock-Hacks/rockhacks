      ...
      <div className="bg-slate-900">
        <nav className="flex items-center justify-between p-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <a className="text-white" href="#">Location</a>
            <a className="text-white" target="_blank" rel="noopener noreferrer"
               href="https://github.com/sjalkote/rockhacks"><Github/></a>
            <Button auto={true} type="secondary"
        ...
        <section className="p-4">
          ...
          <p className="mt-4 text-lg text-gray-400">
            yeah idk write something here I guess maybe photos or a description or some stuff from other hack club
            events or like a tour guide of our austin activities idk.
        ...
        <section className="p-4" id="sponsor">
          ...
          <p className="mt-4 text-lg text-gray-400">
            yeah we have a big button in the center here that says SIGN UP and it has confetti.
            yeah idk write something here I guess maybe photos or a description or some stuff from other hack club
            events or like a tour guide of our austin activities idk.
            random text to take up space to test the smooth scrolling random text to take up space to test the smooth scrolling
            random text to take up space to test the smooth scrolling random text to take up space to test the smooth scrolling
            yeah idk write something here I guess maybe photos or a description or some stuff from other hack club
            events or like a tour guide of our austin activities idk.
            random text to take up space to test the smooth scrolling random text to take up space to test the smooth scrolling
